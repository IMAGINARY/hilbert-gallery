...
# NOTE:
#
# This code was copied from rails/activestorage/lib/active_storage/fixture_set.rb
# because it's not yet part of any release. Once Rails is upgraded to a version
# that includes ActiveStorage::FixtureSet, this file can be removed and
# calls replaced with the official version in the fixtures.yml file.
#
